...
Usage:
    python create_multi_venue_comparison_report.py <csv_file> <current_start> <current_end> <previous_start> <previous_end> [--format html|markdown|pdf|all]

Example:
    python create_multi_venue_comparison_report.py ../example-data/survey.csv 2026-01-01 2026-01-31 2025-12-01 2025-12-31
"""
