...
- [ ] 2.1 Create `python/create_venue_period_comparison_report.py` script
- [ ] 2.2 Implement CSV filtering for current and previous periods
- [ ] 2.3 Implement delta and percent change calculations
- [ ] 2.4 Implement trend threshold logic (±0.5 points)
- [ ] 2.5 Integrate with existing `ai_analysis.py` for venue-level analysis
- [ ] 2.6 Add comparison context to AI analysis prompts
- [ ] 2.7 Test with sample data (single venue, month and quarter comparisons)

## 3. Report 1: Venue Period Comparison - Templates

- [ ] 3.1 Create `templates/period-venue-comparison-browser.html` template
- [ ] 3.2 Create `templates/period-venue-comparison-pdf.html` template
- [ ] 3.3 Create `templates/period-venue-comparison-report.md.j2` template
- [ ] 3.4 Add CSS styling for trend indicators (↑ ↓ →) and comparison columns
- [ ] 3.5 Add delta and percent change display in metric cards
- [ ] 3.6 Test template rendering with sample data

## 4. Report 2: Multi-Venue Single Period - API & Data

- [ ] 4.1 Create `python/create_multi_venue_period_report.py` script
- [ ] 4.2 Implement period summary calculation using `calculate_period_summary()`
- [ ] 4.3 Implement composite score calculation for all venues
- [ ] 4.4 Implement venue ranking by composite score
- [ ] 4.5 Extract and aggregate comment themes from current period
...
- [ ] 5.1 Create `templates/multi-venue-period-browser.html` template
- [ ] 5.2 Create `templates/multi-venue-period-pdf.html` template
- [ ] 5.3 Create `templates/multi-venue-period-report.md.j2` template
- [ ] 5.4 Add CSS styling for venue ranking table and composite score display
- [ ] 5.5 Add metric cards showing aggregated metrics
- [ ] 5.6 Add venue ranking section with composite scores and component breakdown
- [ ] 5.7 Add comment themes section with frequency counts and venue attribution
- [ ] 5.8 Test template rendering with sample data

## 6. Report 3: Multi-Venue Period Comparison - API & Data

- [ ] 6.1 Create `python/create_period_comparison_report.py` script
- [ ] 6.2 Implement dual period filtering (current and previous)
- [ ] 6.3 Implement period summary calculation for both periods
- [ ] 6.4 Implement composite score calculation for both periods
- [ ] 6.5 Implement venue ranking comparison and change detection
- [ ] 6.6 Implement delta calculations for aggregated metrics
- [ ] 6.7 Implement ranking change identification (movers, new top 3, etc.)
- [ ] 6.8 Extract and aggregate comment themes from current period only
...
- [ ] 7.1 Create `templates/period-comparison-browser.html` template
- [ ] 7.2 Create `templates/period-comparison-pdf.html` template
- [ ] 7.3 Create `templates/period-comparison-report.md.j2` template
- [ ] 7.4 Add CSS styling for comparison columns (Current | Previous | Change | % Change | Trend)
- [ ] 7.5 Add metric cards showing aggregated metrics with deltas
- [ ] 7.6 Add venue ranking comparison section with ranking changes
- [ ] 7.7 Add trend indicators for significant changes (±0.5 threshold)
- [ ] 7.8 Add response count comparison and warning for ±20% differences
...
- [ ] 8.4 Implement `get_period_ai_analysis()` function in `ai_analysis.py`
